...
- #### Options 
    ...
    `-f` reads file index and is required  
        ...
        the example:  
	![file.index.png]
	(https://bitbucket.org/repo/bboE8M/images/1070799385-file.index.png)  
    ...
    - `-s [none/noscaling/auto/pareto/]`   
        ...
        7, 142*. Other scaling options mentioned in this paper, such as **vast**
...
- #### Options
    ...
    - `--ica`  
    This option is required for plotting ICA results. All *principal components*
    mentioned above will be replaced by *independent components* when `--ica` is
    turned on.  
    - `--plot`  
