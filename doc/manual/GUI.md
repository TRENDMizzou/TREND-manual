...
"binned" for compression or uniformity. The `bintimes` parameter for this 
 can be speicified. Detail descriptions can be found in the [manual](/.manual.md). In the `all_purpose` menu,  ICA (independent component analysis) can be selected instead of PCA. When 
